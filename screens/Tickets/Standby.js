// //-----------------  Create----------------------
// import { Alert, Dimensions, FlatList, Platform, Pressable, SafeAreaView, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native'
...
//                 try {
//                     // Update a document
//                     const docRef = await updateDoc(doc(db, "tickets", route.params?.id), {
...
//     //         await updateDoc(doc(db, "tickets", route.params.id))

//     //         alert("Votre ticket a bien été modifié.")
//     //         navigation.goBack()
//     //     }
...
//             try {
//                 const docSnap = await getDoc(doc(db, "tickets", route.params?.id));
//                 console.log("the record is:", docSnap.data())

//                 setDepPlace(docSnap.data().depPlace)
//                 setDestPlace(docSnap.data().destPlace)
//                 setPrice(docSnap.data().price)
//                 setCompanyName(docSnap.data().companyName)
//                 setTravelDate(docSnap.data().travelDate)
//                 setTravelHour(docSnap.data().travelHour)
//                 setTravelMinute(docSnap.data().travelMinute)
//                 setSeatType(docSnap.data().seatType)
//                 setDdurationHour(docSnap.data().durationHour)
//                 setDurationMinute(docSnap.data().durationMinute)

//             } catch (err) {
//                 console.log("Error getting the ticket : ", err);
//             }
//         }

//         useEffect(() => {
//             console.log("The id HERE is: ", route.params.id)
//             if (route.params.id !== undefined && route.params.id !== "") {
//                 getOneTicket();
//             }
...
//                         <View
//                             style={{
//                                 marginTop: 25, backgroundColor: "#F7F7FB", elevation: 5, borderRadius: 5
//                             }}>

//                             <View>
//                                 <Text style={{ marginHorizontal: 1, fontSize: 14, fontWeight: "500" }}> Compagnie : </Text>
//                             </View>
//                             <Pressable
//                                 onPress={() => setCompanyModal(!companyModal)}
//                                 style={{
//                                     marginTop: 10,
//                                     flexDirection: "row",
//                                     alignItems: "center",
...
//                                     placeholder={companyName ? companyName : 'Compagnie'}
//                                     onChangeText={setCompanyName}
//                                     placeholderTextColor={companyName ? 'green' : "grey"}
//                                     editable={false}
//                                 />
//                                 <Entypo name="check" size={18} color={companyName ? "green" : "orange"} />
...
//                                 onPress={addTicket}
//                                 style={{
//                                     marginTop: 25, backgroundColor: "green", width: 358, paddingHorizontal: 5, height: 45,
...
//                                     return (
//                                         <Pressable onPress={() => {
//                                             setDestPlace(item.station_Name);
//                                             setDestModal(!destModal)
//                                         }}
//                                         >
//                                             <View style={{ marginVertical: 10 }}>
...
//                 {/*____________________ Company Modal________________________*/}
//                 <BottomModal
//                     swipeThreshold={50}
//                     onBackdroPress={(e) => setCompanyModal(!companyModal)}
//                     swipeDirection={['up', 'down',]}
...
//                         })
//                     }
//                     onHardwareBackPress={() => setCompanyModal(!companyModal)}
//                     visible={companyModal}
//                     onTouchOutside={(e) => setCompanyModal(!companyModal)}
//                 >
...
//                                     return (
//                                         <Pressable onPress={() => {
//                                             setCompanyName(item.compagnie_Name);
//                                             setCompanyModal(!companyModal)
//                                         }}
//                                         >
//                                             <View style={{ marginVertical: 10, backgroundColor: "green", borderRadius: 10, }}>
//                                                 <Text style={{ color: "white", fontSize: 24, fontWeight: "500" }} > {item.compagnie_Name} </Text>
//                                             </View>
//                                         </Pressable>
//                                     )
//                                 }
...
//             await deleteDoc(ref);
//         } catch (e) {
//             console.log('Error deleting ticket', e.message);
//         }
//     };

//     // updateTicket
//     const [ticketId, setTicketId] = useState("");
//     const updateTicket = (selectedId) => {
//         console.log("The id is this:", selectedId);
//         setTicketId(selectedId)
//         navigation.navigate("Create", { id: selectedId });
//         // Alert.alert(
//         //     'Confirmation',
//         //     'Are you sure to Update this ticket?',
//         //     [
//         //         { text: 'No' },
//         //         { text: 'Yes', onPress: () => navigation.navigate("Create", 
//         //         { itemId: selectedId._id, action: "update" }) } 
//         //     ],
//         //     { cancelable: true }
//         //   )
//     }
...
//             {isLoading ? (<ActivityIndicator animating={true} color="#ffffff" />) : null}

//             {/* Display list of products or show message when there are no products */}
//             <ScrollView>
//                 {tickets.length === 0 ? (
//                     <View style={{ justifyContent: 'center', alignItems: 'center' }}>
//                         <Text>No ticket yet!</Text>
//                     </View>) : (

//                     tickets.map((ticket) => (
//                         <>
//                             <View key={ticket.id} style={{ padding: 10, }} >
...
//                                     </Pressable>
//                                     <Pressable onPress={() => updateTicket(ticket.id)}>
...
//                                             <Text style={{ fontSize: 20, fontWeight: "500" }} > {ticket.companyName} </Text>
//                                         </View>
...
//                                             <Text style={{ fontWeight: "500", fontSize: 18 }} > {ticket.travelHour} :  {ticket.travelMinute}</Text>
//                                         </View>
...
//                                             <Text style={{ fontSize: 12, color: "gray", fontWeight: "400" }}> {ticket.seatType} </Text>
//                                         </View>

//                                         <View style={{ width: "62%", flexDirection: "row", alignItems: "center" }} >
//                                             <MaterialCommunityIcons name="alarm-check" size={18} color="gray" />
//                                             <Text style={{ fontSize: 12, color: "gray", fontWeight: "400" }}> {ticket.durationHour}h {ticket.durationMinute}mn </Text>
//                                         </View>
...
//                                             <Text style={{ fontSize: 12, fontWeight: "400" }} >  {ticket.depPlace} Otogare {'--->'} {ticket.destPlace} Otogare</Text>
//                                         </View>
//                                     </View>
